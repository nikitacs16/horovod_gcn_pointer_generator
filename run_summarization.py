...
tf.app.flags.DEFINE_float('query_gcn_dropout', 1.0, 'dropout keep probability for the gcn layer')
tf.app.flags.DEFINE_integer('query_gcn_layers', 1, 'Layers at gcn')
tf.app.flags.DEFINE_integer('query_gcn_dim', 256, 'output of gcn ')
